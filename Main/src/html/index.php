...
<head>
  ...
  <nav class="nav-bar">
    ...
    echo '<div class="login">
      <a href="../html/login.php" target="_blank"><button class="btn-login" id="login" type="button" >Login<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
      ...
      echo '<div class="login">
      <form method="post" >
      <button class="btn-login" id="login" type="submit" name="log_out" value="Log Out">Log Out<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
