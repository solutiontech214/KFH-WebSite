            ...
            <div class="col-md-6 c">
                ...
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password" name="a_pass" placeholder="Enter password" style="font-size: 16px; font-weight: 500; color: #000;" />
                        <i class="fa-solid fa-eye eye" onclick=" togglePasswordVisibility()" style="cursor: pointer; color: rgb(0, 0, 0)"></i>
                    </div>
                    <div class="form-group">
                        <label for="confirmPassword">Confirm Password</label>
                        <input type="password" name="c_pass" class="form-control" id="confirmPassword" placeholder="Confirm password" style="font-size: 16px; font-weight: 500; color: #000;" />
