...
<body>
    ...
    <div class="content">
        <div class="image-container">
            <img src="../../Images/img9.jpg" alt="" width="700px" height="400px" />
        </div>
        <div class="ceremony">
            <h2>Opening Ceremony in Solapur</h2>
        </div>
    </div>

    <div class="aboutus">
        <p>
            Kandre's Fitness Hub has been in fitness industry for over 9 years. With
            great success in Pandharpur. <br />
            Another one is expanded in Solapur.
        </p>
        <div class="more">
            <p>
    ...
    <footer>
        <div class="foot f1">
            <div class="address">
                ...
                <span>
                    <h4><b>Solapur:</b></h4>
                    <p>
                        Kandre's Fitness Hub, Third floor,<br />
                        Mhetre Tower, Vishwakaran Park,<br />
                        Near Aasara Bridge, Jule Solapur,<br />
                        Solapur, 413004
                    </p>
                </span>
                <span>
                    <h4><b>Pandharpur:</b></h4>
                    <p>
                        Kandre's Fitness Hub,<br />Pandharpur - Pune Road,<br />
                        Isbavi, Pandharpur
                    </p>
                </span>
            </div>
        ...
        <div class="foot f2">
            <div class="follow">
                ...
                <div>
                    <span>
                        <a href="https://www.instagram.com/reel/CyFPB3YoEJy/?utm_source=ig_web_copy_link">
            ...
            <div class="logo" style="width: 20%; height: auto;">
